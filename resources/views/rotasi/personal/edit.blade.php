                            ...
                            @foreach ($cabangs as $cabang)
                                <label>
                                    <input type="radio" name="lokasi_awal_id" id="lokasi-awal-{{ $cabang->id }}"
                                        value="{{ $cabang->id }}"
                                        {{ old('lokasi_awal_id') == $cabang->id || (!old('lokasi_awal_id') && $pengajuan->lokasi_awal_id == $cabang->id) ? 'checked' : '' }}>
                                    {{ $cabang->nama }}
                                </label>
                            @endforeach
                        </div>
                            ...
                            @foreach ($cabangs as $cabang)
                                <label>
                                    <input type="radio" name="lokasi_tujuan_id" id="lokasi-tujuan-{{ $cabang->id }}"
                                        value="{{ $cabang->id }}"
                                        {{ old('lokasi_tujuan_id') == $cabang->id || (!old('lokasi_tujuan_id') && $pengajuan->lokasi_tujuan_id == $cabang->id) ? 'checked' : '' }}>
                                    {{ $cabang->nama }}
                                </label>
                            @endforeach
                        </div>
