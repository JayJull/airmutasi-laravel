...
<body class="font-sans tracking-wider text-lg">
    ...
    <main class="min-h-screen">
        <div class="text-xl font-semibold text-gray-800 px-4 py-2 bg-gray-100 flex gap-4">
            ...
            <a href="/personel/konsep" class="underline">Konsep</a>
        </div>
        ...
        <div class="flex px-4 py-2 gap-2">
            @foreach ($konseps as $konsep)
                <div>
                    <a href="{{$konsep->berkas}}" class="flex gap-2" target="_blank">{{ $konsep->name }} <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                    ...
                    <iframe src="{{ $konsep->berkas }}" frameborder="0"></iframe>
                </div>
            @endforeach
        </div>
    </main>
