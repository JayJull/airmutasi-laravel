    ...
    <main class="min-h-screen">
        <section class="p-8">
            <div class="bg-white rounded-lg border-2 border-[#293676]">
                <div class="flex justify-between items-center p-4 border-b-2 border-[#293676] text-[#293676]">
                    ...
                    @can('admin')
                        <a href="/personel/add"
                            class="bg-[#7186F3] hover:bg-[#435EEF] duration-200 text-white px-4 py-2 rounded-lg font-semibold">Tambah
                            +</a>
                    @endcan
                </div>
                <div>
                    ...
                    @foreach ($cabang->personels as $personel)
                        <div
                            ...
                            <p class="col-span-2 text-center break-all">{{ $personel->jabatan }}</p>
                            <p>{{ $personel->masa_kerja }} Tahun</p>
