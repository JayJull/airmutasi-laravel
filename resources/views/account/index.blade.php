...
<body class="bg-[#373737] font-sans tracking-wider text-lg">
    ...
    <main class="min-h-screen flex justify-center items-center">
        <section class="rounded-lg flex flex-col-reverse md:flex-row gap-4 bg-white mx-8 my-2 p-4 sm:w-2/3 min-h-[50vh]">
            <aside class="flex flex-col md:max-w-[30%] gap-2">
                <section class="flex flex-col flex-grow">
                    <a href="/akun/edit" class="underline text-blue-500 hover:bg-slate-200 p-2 duration-300">Edit Profile</a>
                    @can('admin')
                        <a href="/akun/add" class="underline text-blue-500 hover:bg-slate-200 p-2 duration-300">Buat
                            akun personel baru</a>
                        <button popovertarget="cabang-assign" class="text-left underline text-blue-500 hover:bg-slate-200 p-2 duration-300">Daftarkan cabang ke
                            akun</button>
                ...
                <a href="/logout"
                    class="bg-red-500 hover:bg-red-600 duration-300 text-white text-center font-semibold p-2 rounded-lg">Logout</a>
            </aside>
            <aside class="flex flex-col flex-grow">
                <div class="bg-blue-100 p-2 rounded-md flex flex-col flex-grow items-center gap-2">
