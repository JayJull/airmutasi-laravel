    ...
    <main class="px-8 py-16">
            ...
            <aside class="w-3/5 flex flex-col gap-4">
                <div class="flex flex-col sm:flex-row justify-between sm:items-center gap-2">
                    ...
                    <aside class="flex items-center gap-4">
                        <a href="/akun/edit"
                            class="px-4 py-2 bg-black text-white opacity-80 hover:opacity-100 duration-300 rounded-md">Edit</a>
                        @can('admin')
                            <button
                                class="px-4 py-2 bg-black text-white opacity-80 hover:opacity-100 duration-300 rounded-md"
        ...
        @can('admin')
            <section popover="auto" id="admin-action" class="rounded-md p-4 shadow-lg">
                <div class="flex flex-col gap-2">
                    <a href="/akun/add"
                        class="px-4 py-2 bg-black text-white opacity-80 hover:opacity-100 rounded-md duration-300">Buat
                        akun personel baru</a>
                    <button popovertarget="cabang-assign"
                        class="px-4 py-2 bg-black text-white opacity-80 hover:opacity-100 rounded-md duration-300">Daftarkan
                        cabang ke
                        akun</button>
